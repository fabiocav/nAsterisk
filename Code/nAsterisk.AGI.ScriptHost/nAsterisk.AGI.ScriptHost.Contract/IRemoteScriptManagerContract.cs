...
namespace nAsterisk.AGI.ScriptHost.Contract
{
    [AddInContract]
    public interface IRemoteScriptManagerContract : IContract
    {
        void Execute(IAGIScriptHostContract host, Dictionary<string, string> configurationSettings);
    }
}
