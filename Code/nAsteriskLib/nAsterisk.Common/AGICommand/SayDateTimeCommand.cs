...
namespace nAsterisk.AGICommand
{
	public class SayDateTimeCommand : BaseAGICommand, IProvideCommandResult
	{
		...
		public override string GetCommand()
		{
			...
			return string.Format(commandFormat, (_time.ToUniversalTime() - (new DateTime(1970,1,1,0,0,0).ToUniversalTime())).TotalSeconds, AsteriskAgi.GetDigitsString(_escapeDigits), _format, _timeZone);
		}
